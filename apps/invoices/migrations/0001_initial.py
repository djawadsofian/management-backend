    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tva', models.DecimalField(decimal_places=2, default=Decimal('0.00'), help_text='Tax percentage (TVA)', max_digits=5, validators=[django.core.validators.MinValueValidator(Decimal('0.00')), django.core.validators.MaxValueValidator(Decimal('100.00'))])),
                ...
                ('status', models.CharField(choices=[('DRAFT', 'Draft'), ('ISSUED', 'Issued'), ('PAID', 'Paid')], db_index=True, default='DRAFT', max_length=20)),
            ],
            options={
                'ordering': ['-created_at'],
            },
